...
public class BasicStockViewTest {
  ...
  public void printXDayCrossoversWorks() {
    ...
    String expectedOutput = "Here are all the 5-day crossovers for the AAPL stock starting at 2023-06-01:\n\n" +
            "2023-05-20\n" +
            "2023-05-25\n\n";
    assertEquals(expectedOutput, sb.toString());
  }
  ...
  public void printStockGainWorks() {
    ...
    String expectedOutput = "The gain for stock AAPL from 2023-01-01 to 2023-06-01 was $150.75.\n\n";
    assertEquals(expectedOutput, sb.toString());
  }
  ...
  public void printStockAverageWorks() {
    ...
    String expectedOutput = "The average for stock AAPL on 2023-06-01 for 30 days was $135.50.\n\n";
    assertEquals(expectedOutput, sb.toString());
  }
